...
int xc_sched_rttest_domain_set(xc_interface *xch,
                          uint32_t domid,
                          struct xen_domctl_sched_rttest_params *sdom);
int xc_sched_rttest_domain_get(xc_interface *xch,
                          uint32_t domid,
                          struct xen_domctl_sched_rttest_params *sdom,
                          uint16_t num_vcpus);

int xc_sched_rttest_domain_get_num_vcpus(xc_interface *xch,
                                    uint32_t domid,
                                    uint16_t *num_vcpus);
